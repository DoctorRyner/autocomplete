...
describe('sum :: Number -> Number -> Number', function () {
    var res = sum(1)(2);
    it('return value should be a number', function () { return chai_1.assert.typeOf(res, 'number'); });
    it('when pass 1 and 2 it should return 3', function () { return chai_1.expect(res).to.equal(3); });
});
